            ...
            children: [
              ...
              SizedBox(
               ...
               InkWell(
                 onTap: ()
                 {
                   cubit.acceptFriendsRequest(acceptFriendRequestsBody: FriendRequestBody(requestId: request!.id!));
                 },
                 child: const Icon(
                  Icons.check,
                  size: 30,
              ...
              SizedBox(
               ...
               InkWell(
                 onTap: ()
                 {
                   cubit.rejectFriendsRequest(rejectFriendRequestsBody: FriendRequestBody(requestId: request!.id!));
                 },
                 child: const Icon(
                  Icons.close,
                  size: 30,
